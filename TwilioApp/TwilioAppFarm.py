...
def getData(identifier):
    FBURL = 'https://farmsd.firebaseio.com/modules.json'
    ...
    #listFromDatabase = [None]*5
    # listFromDatabase[0] = parsedDataA;
    # listFromDatabase[1] = parsedDataB;
    # listFromDatabase[2] = parsedDataC;
    # listFromDatabase[3] = parsedDataD;
    # listFromDatabase[4] = parsedDataE;
    ...
    return listFromDatabase[identifier]

# def updDataLocalVaribles():
#     temporaryList = getData()
...
def farmText():
    ...
    if from_number in callers:
    	if module_request in modules:
            message = getData(modules[module_request])
    	else:
